...
public class GOEnemyGuard extends GameObject {
    ...
    GOEnemyGuard(Context context, float worldStartX, float worldStartY, char type, int pixelsPerMetre) {
        final String BITMAP_NAME = "platformer_enemy_1";
        ...
        setBitmapName("platformer_enemy_1");
